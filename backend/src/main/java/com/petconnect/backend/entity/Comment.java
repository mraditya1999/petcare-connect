package com.petconnect.backend.entity; ////package com.petconnect.backend.entity;
////
...
//    }
//
//    public Comment(String commentId, String forumId, Long userId, String text, Date createdAt, Set<Long> likedByUsers, Set<Like> likes, Comment parentComment, Set<Comment> replies) {
//        this.commentId = commentId;
//        this.forumId = forumId;
//        this.userId = userId;
//        this.text = text;
