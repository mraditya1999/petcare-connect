...
const Navbar = () => {
  ...
  return (
    <div className="relative">
      {/* Desktop Navbar */}
      <nav className="fixed left-0 right-0 top-6 z-50 mx-auto hidden w-[90vw] max-w-4xl items-center justify-between rounded-full bg-card px-6 py-2 text-foreground shadow-md md:flex">
